...
public class MainWindow extends UiPart {
    ...
    @FXML
    private AnchorPane entryListPanelPlaceholder;
    ...
    public static MainWindow load(Stage primaryStage, Config config, UserPrefs prefs, Logic logic) {
        ...
        mainWindow.configure(config.getAppTitle(), config.getSchedulerName(), config, prefs, logic);
        return mainWindow;
    }

    private void configure(String appTitle, String schedulerName, Config config, UserPrefs prefs,
                           Logic logic) {
    ...
    public AnchorPane getEntryListPlaceholder() {
        return entryListPanelPlaceholder;
    }
